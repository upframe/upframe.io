...
const MainCategories = props => {
  ...
  return (
    <div id='categories-list'>
      <h1 className='font-150 fontweight-medium' data-aos='fade-left'
      ...
      <ul className='list-reset grid'>
        <Link to='/business' data-aos='fade-left' data-aos-delay='300' data-aos-offset='0'>
        ...
        <Link to='/design' data-aos='fade-left' data-aos-delay='400' data-aos-offset='0'>
          <li className='category-item'>
        ...
        <Link to='/technology' data-aos='fade-left' data-aos-delay='500' data-aos-offset='0'>
          <li className='category-item'>
